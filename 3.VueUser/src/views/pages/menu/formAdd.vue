...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"80%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="24">
					<el-form-item label="菜单" prop="menujson">
						<el-input v-model="form.menujson" placeholder="菜单" type="textarea"
						:readonly="!isAdd||disabledForm.menujson?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='menujson'){
					form.value.menujson = row[x];
					disabledForm.value.menujson = true;
					continue;
				}
			}
			if(row){
