	...
	<div class="app-contain" :style='{"padding":"0px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"80%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">菜单</div>
					<div  class="info_text" >{{detail.menujson}}</div>
				</div>
				<div class="btn_view">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('menu','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('menu','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
