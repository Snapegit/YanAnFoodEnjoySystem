	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 0 40px","margin":"0 auto","overflow":"hidden","borderRadius":"4px","textAlign":"center","background":"#fff","width":"80%","position":"relative"}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('discussmeishixinxi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/discussmeishixinxiAdd')
	}
	//判断是否从个人中心跳转
	...
	const detailClick = (id) => {
		router.push('discussmeishixinxiDetail?id=' + id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){
