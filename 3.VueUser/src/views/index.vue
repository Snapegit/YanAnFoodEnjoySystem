<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">圣地延安美食乐享系统</div>
			...
			<el-scrollbar wrap-class="scrollbar-wrapper" class="menu_scrollbar">
				<el-menu :default-openeds="[]" :unique-opened="false" :default-active="menuIndex" class="menu_view"
					...
					<template v-for="(menu,index) in menuList" :key="menu.menu">
						...
						<el-menu-item v-else-if="menu.child[0].url=='chat'" :index="index+2+''" class="first_item" @click="chatClick">
							<template #title>
								<span>{{menu.name}}</span>
							</template>
						</el-menu-item>
		...
		<el-dialog v-model="chatVisible" :title="'客服'" width="70%" destroy-on-close @close="delTimer">
			<el-form ref="formRef" :model="chatForm" class="chat_form">
				...
				<div class="input_box">
					...
					<img src="http://clfile.zggen.cn/20231227/6770e31e0cf94673b0c650256b986ae3.png" class="inp_add"
...
<style lang="scss" scoped>
	...
	.bottom_view {
		...
		color: #91bfd6;
		background: url(http://clfile.zggen.cn/20231227/d4b008eabe264e629219819fd4dd7784.jpg) repeat-x center top,#f6a5a1;
		display: flex;
		width: 100%;
		font-size: 14px;
		min-height: 150px;
...
<style lang="scss">
	...
	.menu_popper {
		...
		// 二级总盒子
		.el-menu--popup {
			border: 0px solid #ff8790 !important;
