		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="转发账号" prop="zhuanfazhanghao">
							<el-input class="list_inp" v-model="form.zhuanfazhanghao" placeholder="转发账号"
								 type="text" 								:readonly="!isAdd||disabledForm.zhuanfazhanghao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="美食介绍" prop="meishijieshao">
							<el-input v-model="form.meishijieshao" placeholder="美食介绍" type="textarea"
							:readonly="!isAdd||disabledForm.meishijieshao?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="美食详情" prop="meishixiangqing">
							<editor :value="form.meishixiangqing" placeholder="请输入美食详情" :readonly="!isAdd||disabledForm.meishixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'meishixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.meishixiangqing = res.data.data.meishixiangqing?(res.data.data.meishixiangqing.replace(reg,'../../../cl1421469/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='meishijieshao'){
					form.value.meishijieshao = row[x];
					disabledForm.value.meishijieshao = true;
					continue;
				}
				if(x=='meishixiangqing'){
					form.value.meishixiangqing = row[x];
					disabledForm.value.meishixiangqing = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
				...
				if(x=='zhuanfazhanghao'){
					form.value.zhuanfazhanghao = row[x];
					disabledForm.value.zhuanfazhanghao = true;
					continue;
				}
			}
			if(row){
